...
const API_METHOD = `bencina-en-linea/v1/combustibles/vehicular/estaciones/gasolina97.json${API_KEY}`;
const API_URL = `https://api.desarrolladores.energiaabierta.cl/${API_METHOD}`;

// Definir parámetros de consulta
const REGISTRIES = 1000 // Registros a obtener por petición
var PAGE = 3 // Registros a obtener por petición
...
axios.get(API_URL_FILTERS + `&page=${PAGE}`)
    .then(response => {
        ...
        const json_file = path.resolve("output/javascript/97octanos.json");
